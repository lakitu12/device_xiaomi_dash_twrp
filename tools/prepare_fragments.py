...
def main():
    ...
    try:
        ...
        # twrp16 libs 来自 CI 的 F1 (recovery ramdisk, fragment 1)，因为 VAB 设备的 CI vendor_boot:
        # - F0 (vendor ramdisk) 是空的 (vendor ramdisk 在 boot 分区)
        # - F1 (recovery ramdisk) 包含完整的 recovery + system/lib64 所有库
