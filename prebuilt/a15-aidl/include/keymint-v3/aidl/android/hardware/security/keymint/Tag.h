...
template <>
constexpr inline std::array<aidl::android::hardware::security::keymint::Tag, 66> enum_values<aidl::android::hardware::security::keymint::Tag> = {
